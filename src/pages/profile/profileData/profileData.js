  ...
  const handleIconClick = (field) => {
    if (!isEditMode && profile[field]) {
      if (field === "mail") {
        ...
        window.open(
          `https://maps.google.com/?q=${encodeURIComponent(profile[field])}`,
          "_blank"
        );
      ...
      <Box maxWidth="800px" margin="auto" padding={4}>
        ...
        >
          <Avatar
            ...
            mb={4}
            onClick={() =>
              isEditMode && document.getElementById("profilePicInput").click()
            }
          ...
          <Flex direction={{ base: "column", md: "row" }} align="center" mt={4}>
            {(isEditMode || profile.resume) && (
              <Button
                colorScheme={profile.resume ? "orange" : "gray"}
            ...
            <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4}>
              ...
              {(isEditMode || profile.mail) && (
                <IconButton
                  ...
                  bg={
                    profile.mail
                      ? "linear-gradient(to right, #DB4437, #D62D20)"
                      : "gray.400"
                  }
                  color="white"
                  _hover={{
            ...
            <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4}>
              {(isEditMode || profile.twitter) && (
                <IconButton
                  ...
                  bg={
                    profile.twitter
                      ? "linear-gradient(135deg, #1DA1F2 0%, #14171A 100%)"
                      : "gray.400"
                  }
                  color="white"
                  _hover={{
              ...
              {(isEditMode || profile.facebook) && (
                <IconButton
                  ...
                  bg={
                    profile.facebook
                      ? "linear-gradient(135deg, #3B5998 0%, #4C69BA 100%)"
                      : "gray.400"
                  }
                  color="white"
                  _hover={{
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          <ModalOverlay />
          <ModalContent>
          <ModalHeader>Update {popupField.charAt(0).toUpperCase() + popupField.slice(1)}</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              {popupField === "name" && (
                <Input
              ...
              {popupField === "twitter" && (
                <InputGroup>
                  ...
                  <Input
                    name={popupField}
                    value={profile[popupField].replace(
                      "https://twitter.com/",
                      ""
                    )}
                    onChange={handleChange}
